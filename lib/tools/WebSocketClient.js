...
define(['jquery', 'websocket', './Write'],
  ...
  WebSocketClient.prototype.connect = function (onComplete) {
    ...
    client.on('connect', function (connection) {
          ...
          if (message.type === 'utf8') {
            ...
            if ((typeof test.confirmProps !== 'undefined') &&
              ...
              if (typeof test.result === 'string') {
                ...
                if (onComplete) {
                  test.obj.assertAnd(test.result, message.utf8Data, 'tried to compare json strings');
                } else {
                ...
                if (onComplete) {
                  test.obj.assertAnd(test.result,
      ...
      connection.sendAndVerify = function (command, result, testObj, confirmProps) {
      ...
      connection.sendWith = function (params) {
        ...
        test.result = (params.expect) ? params.expect : undefined;
