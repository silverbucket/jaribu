...
if(!net.silverbucket.always) net.silverbucket.always={};

net.silverbucket.always = function(undefined) {
    var sys = require('sys');
    var black = '\u001b[30m';
    var red = '\u001b[31m';
    var green = '\u001b[32m';
        ...
        Stub.prototype = {
            ...
            getFunc: function() {
                ...
                func = function(params) {
                    _this_stub.called = true;
                    _this_stub.numCalled = _this_stub.numCalled + 1;
                    return _this_stub.returnFunc(params);
                };
                return func;
            }
        };
...
module.exports = net.silverbucket.always;