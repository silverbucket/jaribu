module.exports = function(undefined) {
    ...
    pub.loadSuite = function(s) {
        ...
        Test.prototype = {
            ...
            write: writeFunc,
            status: undefined,
            assertFail: undefined, // if true, a failing test passes, and passing test fails
            timeout: 10000,
            name: "",
            desc: "",
            setup: undefined,
    ...
    var run = function(o, type) {
        ...
        mergeToRes(local.run(res)); // merge return result to res object
        //local.run(); // merge return result to res object
