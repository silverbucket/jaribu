...
net.silverbucket.teste = function(undefined) {
    ...
    var fail = function(o, type, msg) {
        ...
        msg = msg + " " + c.yellow + o[type]._message + c.reset;
        ...
        (function waitResult() {
            if (local.result() === undefined)  {
                ...
                if ((typeof local.assertFail === 'boolean') && (local.assertFail === true)) {
                    sys.print("this test passed, but that's " + c.red + 'NOT OK' + c.reset + " because it's supposed to fail.");
                    fail(o, type);
                } else {
                    pass(o, type);
                }
            } else {
                console.log(c.red + "ERROR GETTING RESULT" + c.reset);
                fail(o, type);
            }
        })();
    };
